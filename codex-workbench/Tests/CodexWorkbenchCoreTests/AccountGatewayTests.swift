...
func runAccountGatewayTests(_ runner: inout TestRunner) {
    let payloadJSON = #"{"generated_at":"2026-07-14T13:55:08.500568+00:00","active_profile":"hd-master","desktop_status":{"running":true,"managed":true,"state":"managed_default_home","message":"ok","active_profile":"hd-master"},"profile_roles":{"task":{"profile":"hd-master","source":"recent_active_thread_rate_limit_match","confidence":"inferred","observed_at":1784037295,"thread_id":"019f6067-342c-7b22-a9fc-cd50ded08d86"},"desktop":{"profile":"hd-master","source":"desktop_bridge_record","confidence":"confirmed"},"attribution":{"profile":"hd-master","source":"attribution_ledger","confidence":"confirmed"},"task_matches_desktop":true},"profiles":[{"name":"hd-master","auth":"present","config":"present","account":{"type":"chatgpt","email":"must-not-be-modeled@example.com"},"rate_limits":{"primary":{"used_percent":11,"remaining_percent":89,"window_minutes":10080,"resets_at":1784632385},"secondary":null,"reset_credits":{"available":true,"available_count":3}},"reset_credit_details":{"available_count":3,"next_expiration_at":null},"remote_stale":false,"remote_error":null}]}"#
